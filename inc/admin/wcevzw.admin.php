...
function wcevzw_woo_activation_check()
{
	if( !is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
		...
		wp_die( wp_kses( '<b>Warning</b> : Install/Activate Woocommerce to activate "Embed Videos For Product Image Gallery Using WooCommerce" plugin.' , 'embed-videos-product-image-gallery-woocommerce' ) );
	}
}
